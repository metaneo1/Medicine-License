...
//using MvcBaseApp.DataTypeParsers;
...
namespace MvcBaseApp.Controllers
{
    ...
    //    where T : class, IEntityWithId, IEntityWithDocument, IParsable, new()
    ...
    //            return null;
    //        }
    //        if (document.body != null && document.Path == null)
    //        {
    ...
    //        }
    //        var filePath = Path.Combine(Server.MapPath(PATH), document.Path);
    //        var filedata = System.IO.File.ReadAllBytes(filePath);
    //        contentType = MimeMapping.GetMimeMapping(document.RealFileName);

    //        cd = new System.Net.Mime.ContentDisposition
    //        {
    //            FileName = document.RealFileName,
    //            Inline = false,
    //        };
    ...
    //            oldDocument.Id_DocumentType = document.Id_DocumentType;
    ...
    //            oldDocument.Description = document.Description;
    //            oldDocument.Id_DocumentType = document.Id_DocumentType;
    //            oldDocument.RealFileName = document.RealFileName;
    ...
    //       // document.Id_DocumentType = DataTypeParser.Int(formData["Document.Id_DocumentType_VI"]);

    //        document.Description = DataTypeParser.String(formData["Document.Description"]);

    //        document.RealFileName = null;
    ...
    //            {
    //                document.RealFileName = fileContent.FileName;
    //                var filename = Guid.NewGuid().ToString();
    //                var filePath = Path.Combine(Server.MapPath(PATH), System.IO.Path.GetFileName(filename));
    ...
    //{
    //    public static int GetAlwaysDocuemntId<T>(object t, MedlicenseEntities entities) where T : class, IEntityWithId, IEntityAlwaysWithDocument, new()
    //    {
    //        var s = (T)t;
    //        return entities.Set<T>().Where(x => x.Id == s.Id).Select(x => x.Id_documents).FirstOrDefault();
    //    }
    //}
