...
namespace MvcBaseApp.Controllers
{
    public class DocumentInRequestController : BaseDocumentController<DocumentInRequest, vw_DocumentInRequest>
    {
        public ActionResult DataBindingPartial(int? Id_Request = null)
        {
            ...
            var list = DatabaseProvider.DB.GetDocumentAndRequestElements(idtype, Id_Request).OrderBy(x=>x.OrderNumber).ToList();
        ...
        {
            return new DocumentInRequest() { Id_Request = _Id_Request , Id_RequestElement = _Id_RequestElement, Id_DocumentState = Const.DocumentStateId.Backlog };
        }
        ...
        protected override void FillModel(IndexGridModel<DocumentInRequest> model)
        {
