...
namespace MvcBaseApp.Controllers
{
    public abstract class BaseDictionaryController<T> : BaseController<T> where T : class, IDictionaryEntity, new()
    {
        ...
        public ActionResult GetLookUp(string JsElementName, string CallerConrtoller, int? CurrentValue, LookUpReloadButton buttons = LookUpReloadButton.All, bool? ReadOnly = false)
        {
